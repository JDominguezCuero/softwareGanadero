...
function iniciarSesion() {
    if (window.innerWidth > 850) {
        ...
        document.body.style.backgroundImage = "url('../../../public/assets/images/img1Login.png')";
...
function register() {
    if (window.innerWidth > 850) {
        ...
        document.body.style.backgroundImage = "url('../../../public/assets/images/img1_Registro.jpg')";
